...
const startWsMarketDataStream = () => {
  ...
  let ws_market_data_stream = new WebSocket(`${binance.WEBSOCKET_MARKET_STREAM_URL}/ws`);
...
const ws_user_data_stream = new WebSocket(`${binance.WEBSOCKET_MARKET_STREAM_URL}/ws/${listenKey}`);
